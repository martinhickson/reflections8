//generated using Reflections JavaCodeSerializer [Fri Oct 25 23:07:27 CEST 2019]
package org.reflections8;

public interface MyTestModelStore {

	public interface org {
		public interface reflections8 {
			...
			public interface TestModel$AC3 {
				public interface annotations {
					public interface org_reflections8_TestModel$AC2 {}
					public interface java_lang_annotation_Retention {}
				}
			}
			...
			public interface TestModel$AI1 {
				public interface annotations {
					public interface org_reflections8_TestModel$MAI1 {}
					public interface java_lang_annotation_Retention {}
				}
			}
			...
			public interface TestModel$C1 {
				public interface annotations {
					public interface org_reflections8_TestModel$AC1 {}
					public interface org_reflections8_TestModel$AC1n {}
				}
			}
			...
			public interface TestModel$I2 {
				public interface annotations {
					public interface org_reflections8_TestModel$AI2 {}
				}
			}
