...
import static org.reflections8.util.Utils.prepareFile;
import static org.reflections8.util.Utils.repeat;
 ...
 * </pre>
 * <p>The {@link #save(org.reflections8.Reflections, String)} method filename should be in the pattern: path/path/path/package.package.classname
 * <p>depends on Reflections configured with {@link org.reflections8.scanners.TypeElementsScanner}
 * */
public class JavaCodeSerializer implements Serializer {
    ...
    public String toString(Reflections reflections8) {
        if (reflections8.getStore().get(index(TypeElementsScanner.class)).isEmpty()) {
        ...
        List<String> keys = new ArrayList(reflections8.getStore().get(index(TypeElementsScanner.class)).keySet());
        ...
        for (String fqn : keys) {
            ...
            for (String element : reflections8.getStore().get(index(TypeElementsScanner.class), fqn)) {
